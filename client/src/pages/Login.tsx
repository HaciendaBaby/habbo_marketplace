...
export default function Login() {
  ...
  return (
    <div style={{
      ...
      <div className="w-full p-6" style={glassStyle}>
        <div className="max-w-7xl mx-auto">
          ...
          {step === 'username' && (
            <div className="relative">
              ...
              <form onSubmit={generateCode} className="space-y-4 max-w-md">
                <div>
                  <input
                    type="text"
                ...
                <button
                  ...
                  className="w-full bg-yellow-500 hover:bg-yellow-600 disabled:opacity-50 disabled:cursor-not-allowed text-black font-bold py-3 rounded-lg transition-all uppercase tracking-wide max-w-md"
                >
